      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="text-neutral-400 space-y-2 text-sm">
              <li><Link to="/impressum" className="hover:text-red-600">Impressum</Link></li>
              <li><Link to="/impressum" className="hover:text-red-600">Datenschutz</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-16 pt-8 border-t border-neutral-900 text-center text-xs text-neutral-600">
